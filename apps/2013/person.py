...
##############################################################################
...

    {
        ...
        'company':_('迅达云成'),
        'position':_('首席架构师'),
        'desc':_('从2009年起，开始接触云计算，曾任Joyent公司软件工程师、蓝讯云计算事业部架构师，先任北京迅达云成科技有限公司首席架构师。设计的云计算架构曾满足年收入一千万的客户需求。对计算、存储、网络三大云计算的支柱底层有深入了解。 '),
        'avatar':'131212_bj_liyulai.png',
        'speech':_('《 如何用python开发运维友好的程序 》'),
    },
